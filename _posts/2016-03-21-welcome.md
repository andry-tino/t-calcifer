...
- Tutorial: [Building a cross-platform app]({% post_url 2016-03-21-tutorial %})
- Side tutorial: [How to get a key for Bing Maps API]({% post_url 2016-03-21-bingmaps %}) - Go through this tutorial before starting the real one as it will guide you through generating Bing Maps keys to get everything you need to work with Bing Maps.
